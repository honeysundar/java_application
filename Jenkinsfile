    ...
    stages {
        ...
        stage('Deploy') {
            ...
            steps {
                ...
                sh 'sudo cp /home/ubuntu/workspace/Docker build/target/grants.war /var/lib/tomcat8/webapps/'
                sh 'sudo cp /home/ubuntu/workspace/Docker build/tomcat-users.xml /etc/tomcat8/'
